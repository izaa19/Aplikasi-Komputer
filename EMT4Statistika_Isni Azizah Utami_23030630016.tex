...
\chapter{Creating new Functions}\label{creating-new-functions}
...
\chapter{Some More Tests}\label{some-more-tests}
...
\chapter{Random Numbers}\label{random-numbers}
...
\chapter{Introduction for Users of the R Project}\label{introduction-for-users-of-the-r-project}
...
\chapter{Basic Syntax}\label{basic-syntax}
...
\chapter{Factors and Tables}\label{factors-and-tables}
...
\chapter{File Input and Output (Reading and Writing Data)}\label{file-input-and-output-reading-and-writing-data}
...
\chapter{CSV Files}\label{csv-files}
...
\chapter{Using Tables}\label{using-tables}
...
\chapter{Analyzing a Line}\label{analyzing-a-line}
...
\chapter{Reading from the Web}\label{reading-from-the-web}
...
\chapter{Input and Output of Variables}\label{input-and-output-of-variables}
