...
\chapter{Intersecting Lines and Circles}\label{intersecting-lines-and-circles}
...
\chapter{Garis Sumbu}\label{garis-sumbu}
...
\chapter{Parabola}\label{parabola}
...
\chapter{Contoh Yang Lain}\label{contoh-yang-lain}
...
\chapter{The Triple Spread Rule}\label{the-triple-spread-rule}
...
\chapter{Angle Bisectors}\label{angle-bisectors}
...
\chapter{The Chord Angle}\label{the-chord-angle}
...
\chapter{Dua titik}\label{dua-titik}
...
\chapter{Tiga poin}\label{tiga-poin}
...
\chapter{Empat poin}\label{empat-poin}
...
\chapter{Plot dengan Povray}\label{plot-dengan-povray}
